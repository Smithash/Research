...
class Trainer:
    ...
    def train_one_epoch(self, train_loader, epoch):
        ...
        for batch_num, batch in enumerate(train_loader):
            ...
            view1 = view1.view(-1, 3, self.config.data.image_size, self.config.data.image_size)
            view2 = view2.view(-1, 3, self.config.data.image_size,self.config.data.image_size)
